...
await page.locator('.data-location-table > button').first().waitFor();
...
await page.screenshot({ path: resolve('docs/images/geomap-business-data.png') });
await browser.close();
console.log('Captured docs/images/geomap-business-data.png (1440x900).');
